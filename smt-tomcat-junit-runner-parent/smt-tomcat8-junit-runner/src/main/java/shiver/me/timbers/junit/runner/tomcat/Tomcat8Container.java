 ...
 * @author Karl Bennett
 */
public class Tomcat8Container implements Container<Tomcat> {
    ...
    public Tomcat8Container(Tomcat tomcat) throws ServletException {
        this.tomcat = tomcat;
        ...
        context.setJarScanner(new JarScanner() {
            ...
            public JarScanFilter getJarScanFilter() {
                return new JarScanFilter() {
                    @Override
                    public boolean check(JarScanType jarScanType, String s) {
                        return false;
                    }
                };
            }
