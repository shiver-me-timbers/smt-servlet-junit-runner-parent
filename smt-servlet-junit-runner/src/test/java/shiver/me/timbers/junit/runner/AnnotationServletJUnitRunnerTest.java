...
public class AnnotationServletJUnitRunnerTest {
    ...
    public static class TestContainerConfig implements
            shiver.me.timbers.junit.runner.config.ContainerConfig<TestServletContainer> {
    ...
    public class TestContainer implements Container<TestServletContainer> {
        ...
        @Override
        public void config(
                shiver.me.timbers.junit.runner.config.ContainerConfig<TestServletContainer> containerConfig) {
            containerConfig.configure(server);
        }

        @Override
        public void load(shiver.me.timbers.junit.runner.Servlets servlets) {
